...
import { p as pluginId, g as getTrad, P as PERMISSIONS } from "./index-ffL9aFYP.mjs";
    ...
    /* @__PURE__ */ jsxs(Flex, { hasRadius: true, background: "neutral0", borderColor: "neutral200", gap: 0, children: [
      /* @__PURE__ */ jsx(
        MethodBox,
        {
          ...
          padding: 2,
          children: /* @__PURE__ */ jsx(Typography, { fontWeight: "bold", textColor: colors.text, children: method })
        }
      ),
      /* @__PURE__ */ jsx(Box, { paddingLeft: 2, paddingRight: 2, children: map(formattedRoute, (value) => /* @__PURE__ */ jsxs(
        Typography,
        {
  ...
  const [
  ...
  ] = useQueries([
    {
      ...
      async queryFn() {
        ...
        } = await get2(`/${pluginId}/permissions`);
        return permissions2;
      }
    },
    {
...
const TableBody = ({
  ...
  return /* @__PURE__ */ jsx(Tbody, { children: sortedRoles?.map((role) => /* @__PURE__ */ jsxs(
    Tr,
    {
...
const fetchData = async (toggleNotification, notifyStatus) => {
  try {
    ...
    const { data } = await get2(`/${pluginId}/roles`);
...
//# sourceMappingURL=index-QPZmIKN4.mjs.map
