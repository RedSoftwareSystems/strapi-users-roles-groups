...
import "react";
import { useNotifyAT, Main, HeaderLayout, ContentLayout, Button, Box, Flex, Typography, Grid, GridItem, SingleSelect, SingleSelectOption } from "@strapi/design-system";
...
import { g as getTrad, P as PERMISSIONS, p as pluginId } from "./index-ffL9aFYP.mjs";
...
const AdvancedSettingsPage = () => {
  ...
  const { isLoading: isLoadingData, data } = useQuery(
    [pluginId, "advanced"],
    async () => {
      const { data: data2 } = await get(`/${pluginId}/advanced`);
      return data2;
    },
    {
      onSuccess() {
                    ...
                    /* @__PURE__ */ jsx(GridItem, { col: 6, s: 12, children: /* @__PURE__ */ jsx(
                      SingleSelect,
                      {
                        ...
                        hint: formatMessage({
                          ...
                          defaultMessage: "It will attach the new authenticated user to the selected roles."
                        }),
...
//# sourceMappingURL=index-teH-15b7.mjs.map
