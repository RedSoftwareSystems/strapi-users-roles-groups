...
const index = require("./index-5Wz8SGcD.js");
...
function formatPluginName(pluginSlug) {
  switch (pluginSlug) {
    ...
    case "plugin::upload":
      return "Upload";
    case `plugin::${index.pluginId}`:
      return "Users-permissions extended";
    default:
      return upperFirst__default.default(
...
const Permissions = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 1, children: collapses.map((collapse, index$1) => /* @__PURE__ */ jsxRuntime.jsxs(
    designSystem.Accordion,
    {
      expanded: collapse.isOpen,
      onToggle: () => handleToggle(index$1),
      variant: index$1 % 2 === 0 ? "secondary" : void 0,
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.AccordionToggle,
          {
            ...
            description: formatMessage(
              {
                id: `${index.pluginId}.Plugin.permissions.plugins.description`,
                defaultMessage: "Define all allowed actions for the {name} plugin."
              },
              { name: collapse.name }
            ),
            variant: index$1 % 2 ? "primary" : "secondary"
          }
        ),
...
function BoundRoute({ route }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 2, children: [
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Typography, { variant: "delta", as: "h3", children: [
      formatMessage({
        id: `${index.pluginId}.BoundRoute.title`,
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { hasRadius: true, background: "neutral0", borderColor: "neutral200", gap: 0, children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        MethodBox,
        {
          ...
          padding: 2,
          children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { fontWeight: "bold", textColor: colors.text, children: method })
        }
      ),
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingLeft: 2, paddingRight: 2, children: map__default.default(formattedRoute, (value) => /* @__PURE__ */ jsxRuntime.jsxs(
...
const usePlugins = () => {
  ...
  const [
    ...
    {
      queryKey: [index.pluginId, "permissions"],
      async queryFn() {
        const {
          data: { permissions: permissions2 }
        } = await get2(`/${index.pluginId}/permissions`);
        return permissions2;
      }
    },
    {
      queryKey: [index.pluginId, "routes"],
      async queryFn() {
        const {
          data: { routes: routes2 }
        } = await get2(`/${index.pluginId}/routes`);
        return routes2;
      }
    }
  ]);
...
const CreatePage = () => {
  ...
  const mutation = reactQuery.useMutation((body) => post(`/${index.pluginId}/roles`, body), {
    onError() {
      toggleNotification({
        type: "warning",
        message: {
...
const EditPage = () => {
  ...
  const {
    params: { id }
  } = reactRouterDom.useRouteMatch(`/settings/${index.pluginId}/roles/:id`);
  const { get: get2 } = helperPlugin.useFetchClient();
  ...
  const {
    ...
    refetch: refetchRole
  } = reactQuery.useQuery([index.pluginId, "role", id], async () => {
    const {
      data: { role: role2 }
    } = await get2(`/${index.pluginId}/roles/${id}`);
    return role2;
  });
  const permissionsRef = React__namespace.useRef();
  ...
  const mutation = reactQuery.useMutation(
    (body) => put(`/${index.pluginId}/roles/${id}`, body),
    {
      onError(error) {
        toggleNotification({
          type: "warning",
            ...
            designSystem.HeaderLayout,
            {
              ...
              navigationAction: /* @__PURE__ */ jsxRuntime.jsx(
                helperPlugin.Link,
                {
                  ...
                  to: `/settings/${index.pluginId}/roles`,
                  children: formatMessage({
                    id: "global.back",
                    defaultMessage: "Back"
                  })
...
const TableBody = ({
  ...
  const handleClickEdit = (id) => {
    push(`/settings/${index.pluginId}/roles/${id}`);
  };
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tbody, { children: sortedRoles?.map((role) => /* @__PURE__ */ jsxRuntime.jsxs(
    designSystem.Tr,
    {
      ...helperPlugin.onRowClick({ fn: () => handleClickEdit(role.id) }),
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { justifyContent: "end", ...helperPlugin.stopPropagation, children: [
          /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.CheckPermissions, { permissions: permissions.updateRole, children: /* @__PURE__ */ jsxRuntime.jsx(
            EditLink,
            {
              to: `/settings/${index.pluginId}/roles/${role.id}`,
...
const fetchData = async (toggleNotification, notifyStatus) => {
  try {
    ...
    const { data } = await get2(`/${index.pluginId}/roles`);
...
const deleteData = async (id, toggleNotification) => {
  try {
    ...
    await del(`/${index.pluginId}/roles/${id}`);
  } catch (error) {
    toggleNotification({
      type: "warning",
      ...
      /* @__PURE__ */ jsxRuntime.jsx(
        designSystem.HeaderLayout,
        {
          ...
          primaryAction: /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.CheckPermissions, { permissions: index.PERMISSIONS.createRole, children: /* @__PURE__ */ jsxRuntime.jsx(
            ...
            {
              to: `/settings/${index.pluginId}/roles/new`,
...
const Roles = () => {
  return /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.CheckPagePermissions, { permissions: index.PERMISSIONS.accessRoles, children: /* @__PURE__ */ jsxRuntime.jsxs(reactRouterDom.Switch, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      ...
      {
        path: `/settings/${index.pluginId}/roles/new`,
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      reactRouterDom.Route,
      {
        path: `/settings/${index.pluginId}/roles/:id`,
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      reactRouterDom.Route,
      {
        path: `/settings/${index.pluginId}/roles`,
...
//# sourceMappingURL=index-Ch4YxRzE.js.map
